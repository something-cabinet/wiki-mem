...
acceptance_criteria:
  - text: "EngineState::new() takes an explicit project_root parameter instead of using current_dir()"
  - text: "MainEngine::new() auto-detects root via detect_project_root() and MainEngine::with_root() is used by Tauri; all 23 CLI callers updated"
  - text: "No ghost .wm/ directories are created when running CLI commands from subdirectories, and cargo build + cargo test pass"
---
