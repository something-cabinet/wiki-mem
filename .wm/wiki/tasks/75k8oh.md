...
acceptance_criteria:
  - text: "Search results render as a List with scrollbar and preview scrolling works via Up/Down/PgUp/PgDown"
  - text: "Dashboard PgUp/PgDown scrolls 10 items and the Tab cycle includes Tasks (Help→Search→Graph→Dashboard→Tasks→Help)"
  - text: "ASCII border fallback (ASCII_BORDER, block_bordered) renders correctly in terminals without Unicode support and wm-cli builds"
---
