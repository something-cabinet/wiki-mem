...
acceptance_criteria:
  - text: "fjadra is confirmed as a dependency (workspace dep or direct) in apps/wm-web/src-tauri/Cargo.toml or the workspace Cargo.toml"
  - text: "cargo check -p wm-web compiles cleanly (the compute_layout command's fjadra::force usage builds)"
---
