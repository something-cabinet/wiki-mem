...
id: wiki:tasks:bundle-angular-frontend-with-wm-server-for-npm-distribution
type: task
status: done
priority: medium
tags:
...
acceptance_criteria:
- text: npm install -g @something-cabinet/wm-cli && wm-cli web serves the Angular UI at http://localhost:4090 without any additional build steps
  checked: false
---
