...
- investigation
acceptance_criteria:
- text: Root cause of the 334 orphan pages (zero inbound edges) is identified from the candidate causes, including whether the graph builder counts implicit body-mention edges or only explicit relates_to frontmatter edges
- text: Findings are documented with evidence (edge counts by page category) and a plan of targeted fixes to reduce disconnected pages
---
