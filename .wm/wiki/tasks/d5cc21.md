...
priority: medium
acceptance_criteria:
  - text: "UX audit fixes applied across 9 apps/wm-web files covering Fitts's, Hick's, Gestalt and Jakob's law issues"
  - text: "Accessibility improvements in place (:focus-visible rings, prefers-reduced-motion, aria-labels, keyboard Enter) and hardcoded error/tag colors migrated to theme tokens"
  - text: "ng build passes with no errors"
---
