...
acceptance_criteria:
  - text: "All 10 P1 fixes implemented: tokenize single push, bm25_index parameter for retrieve_context, serde_yaml-based YAML manipulation, pre-computed term_freqs for BM25 score_doc, custom_types parameter for rebuild_snapshot, shared graph::find_path(), single truncate_str (char_indices-based), tracing::warn! on parse_duration failure, sync_skills_to removed"
  - text: "All 108 tests pass after the changes"
---
