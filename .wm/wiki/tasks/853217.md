...
acceptance_criteria:
  - text: "wm-cli mcp starts without wm-server running and tools respond correctly (AC-1)"
  - text: "mcp_proxy.rs and its STATIC_TOOLS constant are deleted (AC-4)"
  - text: "tools/list from wm-cli mcp matches tools/list from wm-server in names, descriptions, and inputSchemas (AC-10)"
---
