...
id: 398z6o
acceptance_criteria:
  - text: "wm_task.create creates a wiki page with type:task frontmatter"
  - text: "wm_task.get reads task-specific fields (status, assignee, ACs, priority) and wm_task.update updates them"
  - text: "wm_task.delete removes a task page"
---
