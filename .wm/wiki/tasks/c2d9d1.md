...
acceptance_criteria:
  - text: "computeLayout() fires only after all graph-* event listeners are registered (moved into the dynamic-import chain or awaited)"
  - text: "graph-settled final positions are still received, including on a cold dynamic import cache"
---
