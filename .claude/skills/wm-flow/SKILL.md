...
When the parallel gate marks tasks as safe, use the `task` tool to spawn subagents that run in their own context and return results. Do NOT create separate sessions for sub-agents.
